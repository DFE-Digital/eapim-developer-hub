...
const page = 'Testing in the sandbox'

class TestingInTheSandbox extends Component {
  render () {
    const {
      user: { data }
    } = this.props
...
export { TestingInTheSandbox }
export default connect(mapStateToProps)(TestingInTheSandbox)
