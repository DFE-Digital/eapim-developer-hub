...
const page = 'Create a test user'

class ApplicationsCreateTestUser extends Component {
  render () {
    const {
      user: { data }
    } = this.props
...
export { ApplicationsCreateTestUser }
export default connect(mapStateToProps)(ApplicationsCreateTestUser)
