...
const page = 'Terms of service'

class ApplicationsTermsOfService extends Component {
  render () {
    const {
      user: { data }
    } = this.props
...
export { ApplicationsTermsOfService }
export default connect(mapStateToProps)(ApplicationsTermsOfService)
