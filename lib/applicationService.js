...
export const getApplication = async (id, req, res) => {
...
export const getApplications = async (user, req, res) => {
  const token = getOAuthToken(req, res)
...
export const registerApplication = async (data, req, res) => {
  const token = getOAuthToken(req, res)
...
export const updateApplication = async (data, req, res) => {
  const token = getOAuthToken(req, res)
...
export const deleteApplication = async (data, req, res) => {
  const token = getOAuthToken(req, res)
