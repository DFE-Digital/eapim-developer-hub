...
const getAuthorisationType = (arr, env) => getTag(arr, `${env}-AuthorisationType`)
...
export const buildTagsModel = (arr) => {
  ...
  data.summary = getTag(arr, 'Summary')
  ...
  if (arr.find(item => item.properties.displayName.indexOf('Environment-1') >= 0)) envs.push('Environment-1')
  if (arr.find(item => item.properties.displayName.indexOf('Environment-2') >= 0)) envs.push('Environment-2')
  if (arr.find(item => item.properties.displayName.indexOf('Environment-3') >= 0)) envs.push('Environment-3')
  if (arr.find(item => item.properties.displayName.indexOf('Environment-4') >= 0)) envs.push('Environment-4')
