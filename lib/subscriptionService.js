...
export const getSubscriptionKeys = async (subscriptionId, environment, res) => {
...
export const getSubscriptions = async (applicationId, res) => {
  const token = getOAuthToken(res)
...
export const postSubscription = async (applicationId, apiName, environment, res) => {
  const token = getOAuthToken(res)
...
export const deleteSubscription = async (subscriptionId, environment, res) => {
  const token = getOAuthToken(res)
